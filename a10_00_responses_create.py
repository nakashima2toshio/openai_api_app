# streamlit run a10_00_responses_create.py --server.port 8501
...
# ----------------------------------------
# [Menu] OpenAI APIの概要
#  01_01  Responsesサンプル(One Shot)
#  01_011 Responsesサンプル(Memory)
# 01_02  画像入力(URL)
# 01_021 画像入力(base64)
...
from helper import (
    init_page, init_messages, select_model, sanitize_key, extract_text_from_response, \
    get_default_messages
)
