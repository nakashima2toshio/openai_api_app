# embeddings: streamlit run a3_02_rag_embeddings.py --server.port=8506
...
# 起動例: `streamlit run a3_02_rag_embeddings.py --server.port 8506`
...
# streamlit run a3_02_rag_embeddings.py
